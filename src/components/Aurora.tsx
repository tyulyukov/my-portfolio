...
export default function Aurora(properties: AuroraProperties) {
  const { colorStops = ['#5227FF', '#7cff67', '#5227FF'], amplitude = 1, blend = 0.5 } = properties;
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      if (program) {
        ...
        program.uniforms.uAmplitude.value = propertiesReference.current.amplitude ?? 1;
        program.uniforms.uBlend.value = propertiesReference.current.blend ?? blend;
